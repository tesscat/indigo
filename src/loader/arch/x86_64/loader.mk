...
$(OUT_DIR)/$(LOADER_SYSROOT_NAME)/: $(BUILD_DIR)/$(LOADER_SYSROOT_NAME)/ $(BUILD_DIR)/$(LOADER_SYSROOT_NAME)/kernel $(BUILD_DIR)/$(LOADER_SYSROOT_NAME)/trampoline $(BUILD_DIR)/$(LOADER_SYSROOT_NAME)/fsdriver
	cp -r $< $@
