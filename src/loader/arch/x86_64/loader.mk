...
$(OUT_DIR)/$(LOADER_SYSROOT_NAME)/: $(BUILD_DIR)/$(LOADER_SYSROOT_NAME)/ $(BUILD_DIR)/$(LOADER_SYSROOT_NAME)/kernel \
	$(BUILD_DIR)/$(LOADER_SYSROOT_NAME)/trampoline $(BUILD_DIR)/$(LOADER_SYSROOT_NAME)/squashfs.iko $(BUILD_DIR)/$(LOADER_SYSROOT_NAME)/initrd
	# TODO: better module system + initrd actually working
	cp -r $< $@
