...
#define PAGE_DISABLE_EXECUTE ((uint64_t)1 << 63)
    ...
    struct PageEntryBase {
        ...
        // read-write
        bool rw : 1;
        // user-supervisor, 1 means accessible by all, 0 means only kernel.
        // remember to set for all higher entries too
        bool allAccessible : 1;
        // is write-through caching enabled? if not, this will be write-back
        // cached
        bool writeThrough : 1;
        ...
        // page size - are we mapping to a 2MiB page instead of a directory of
        // 4KiB ones? (no) This is reserved (0) on PML4-s
    ...
    struct PageTableEntry {
        ...
        // has this page been accessed since we last reset this bit?
        bool accessed : 1;
        // has this page been written to (since presumably we last reset this?
        // TODO: check)
        bool dirty : 1;
        // something about caching - TODO
        bool pageAttributeTable : 1;
        // global, tells processor to not invalidate the TLB instruction for
        // this page upon a MOV to CR3 (TODO: research TLBs and CRs)
        bool global : 1;
        // free space
        uint8_t available : 3;
        // the actual address
